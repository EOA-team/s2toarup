...
if __name__ == '__main__':
    ...
    #    STEP 0        DEFINE THE INPUTS AND OUTPUTS AS WELL AS 
    ...
    unc_scenario_dir = Path(
        '/run/media/graflu/ETH-KP-SSD6/SAT/S2A_MSIL1C_RUT-Scenarios/S2A_MSIL1C_20190530T103031_N0207_R108_T32TMT_20190530T123429'
    )
    # directory where to save the resulting files to
    out_dir = Path(
        '/run/media/graflu/ETH-KP-SSD6/SAT/S2A_MSIL2A_Analysis/S2A_MSIL1C_20190530T103031_N0207_R108_T32TMT_20190530T123429'
    )
    ...
    # uncertainty maps
    l1c_scenarios = out_dir.joinpath('L1C_B*.tif')
    l2a_scenarios = out_dir.joinpath('L2A_B*.tif')
    l1c_band_idx = 5
    l2a_band_idx = 5
    ...
    unc_maps(
        l1c_scenarios=l1c_scenarios,
        l2a_scenarios=l2a_scenarios,
        l1c_band_idx=l1c_band_idx,
        l2a_band_idx=l2a_band_idx,
        out_dir=out_dir_maps
    )

    #    STEP_3        ANALYSIS OF THE SELECTED REGIONS OF INTEREST (ROI)
    # TODO
